//
//  DDPingNetworkActivityIndicator.swift
//  DDPingTools
//
...
class DDPingNetworkActivityIndicator {
    static let shared = DDPingNetworkActivityIndicator()
...
private extension DDPingNetworkActivityIndicator {
    func _createUI() {
